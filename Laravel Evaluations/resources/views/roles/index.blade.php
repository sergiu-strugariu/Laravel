    ...
    <div class="box box-success">
        <div class="box">
            <div class="box-header css-header">
                <div class="row">
                    <div class="col-xs-12"><h3 class="box-page_heading">Roles List</h3></div>
                </div>
                {{--<a href="#" class="editor_create">--}}
                {{--<button class="btn btn-success"><span class="fa fa-plus-circle"></span> Add Role</button>--}}
                {{--</a>--}}
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <table id="roles" class="table responsive nowrap ui celled" cellspacing="0" width="100%" data-model="role">
                    <thead>
                    <tr>
                        <th>Name</th>
                        <th>Slug</th>
