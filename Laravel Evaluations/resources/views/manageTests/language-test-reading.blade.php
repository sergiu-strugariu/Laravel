...
@section('content')
    ...
    <div class="panel" id="filters">
        ...
        <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-md-2 form-group">
                        {!! Form::select('question_level_id', $levels, null, ['class' => 'form-control sel-status column_filter', 'id' => 'status_filter', 'data-placeholder' => 'Level']) !!}
                    </div>
                    <div class="col-md-2 form-group">
    ...
    <aside id="add_new_question" class="control-sidebar control-sidebar-edit edit-template-modal add-new-project-modal unclosable">
        @include('manageTests.partials.modal-reading', ['question' => null])
    </aside>
